...
const recipes = [
  {
    ...
    serving: 4,
    picture:
      "https://thecozycook.com/wp-content/uploads/2019/08/Bolognese-Sauce.jpg",
    level: "Medium",
    duration: 20,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1 : Bring a large pot of salted water to a boil. Add pasta and cook al dente according to package instructions; drain. Reserve 1/2 cup pasta water",
      "Step 2 : Heat the olive oil in a large deep saute pan. Add the beef and season with salt and pepper. Brown the beef and break it into smaller pieces with the back of a wooden spoon until cooked through",
      "Step 3 : Add onions and garlic; and season with oregano, basil and crushed red pepper. Saute for about 5 minutes until they soften. Add crushed tomatoes and tomato paste and pasta water. Mix to combine, bring mixture to a boil and then simmer on low covered for 30 minutes",
      "Step 4 : Toss the pasta with the bolognese sauce and top with fresh basil, if desired.",
    ],
  ...
  },
  {
    ...
    serving: 2,
    picture:
      "https://feelgoodfoodie.net/wp-content/uploads/2021/03/Chocolate-Hazelnut-Smoothie-Bowl-5.jpg",
    level: "Easy",
    duration: 5,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1 : Place the milk into a high speed blender first. Then add the frozen bananas, Nutella and cacao powder.",
      "Step 2 : Blend thoroughly on high speed for 1 minute until the mixture is completely smooth. You may need to stop and scrape down the blender depending on the strength of the blender you’re using.",
      "Step 3 : Taste and adjust the flavor as needed, by adding a sweetener of choice for added sweetness or more cacao powder for a richer chocolate flavor.",
      "Step 4 : Pour into a bowl and top if off chocolate chips, hazelnuts and cacao nibs, if desired.",
      "Step 5 : Serve immediately for best flavor and consistency.",
    ],
    creator: "Yumna Jawad",
  ...
  },
  {
    ...
    serving: 2,
    picture:
      "https://feelgoodfoodie.net/wp-content/uploads/2021/03/smoked-salmon-bagel-10.jpg",
    level: "Easy",
    duration: 10,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1 : In a small bowl, combine the cream cheese, lemon juice, fresh dill and salt and pepper, to taste.",
      "Step 2 :Toast the bagels, then spread the cream cheese mixture on both sides of the bagel. Add the cucumbers, smoked salmon, capers and red onions on the bottom of the toasted bagels. Top with the top of the bagels.",
    ],
    creator: "Mummy",
  ...
  },
  {
    ...
    serving: 4,
    picture:
      "https://feelgoodfoodie.net/wp-content/uploads/2021/01/Peanut-Butter-Banana-Muffins-10.jpg",
    level: "Medium",
    duration: 15,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1 : Preheat the oven to 375°F. Line a standard muffin pan with muffin papers.",
      "Step 2 : In a large bowl, beat the bananas with a hand mixer until well mashed.",
      "Step 3 : Add the peanut butter and honey. Beat until smooth. Add the eggs and vanilla. Beat on low until just combined.",
      "Step 4 : Combine the oat flour, baking powder, baking soda, salt and spices in a small bowl or large measuring cup. Stir to distribute.",
      "Step 5 : Transfer the dry ingredients to the wet and stir with a spatula until just combined. Do not over mix. Some small lumps are ok.",
      "Step 6 : Scoop the batter into the prepared muffin pan, filling the cups just below the top. Add sliced bananas, if using.",
      "Step 7 : Bake for 15-17 minutes, until a cake tester inserted in one of the center muffins comes out with just a couple crumbs. Allow to cool in the pan for 10 minutes before serving.",
    ],
    creator: "Alexis",
    type: ["Breakfast", "Snack"],
  },
  {
    ...
    serving: 6,
    picture:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F5078300.jpg&w=708&h=708&c=sc&poi=face&q=85",
    level: "Medium",
    duration: 55,
    ingredients: [
      {
    ...
    instructions: [
      ...
      "Step 2: Toss Brussels sprouts, apple, and pancetta with 1 tablespoon olive oil and rosemary in a bowl. Spread into a single layer on a sheet pan.",
      "Step 3: Leave space on the pan for the chicken thighs. Toss chicken with the remaining 1 tablespoon oil in the same bowl; place on the sheet pan. Sprinkle salt and pepper on top.",
      "Step 4: Bake in the preheated oven, stirring the Brussels sprouts mixture every 15 minutes, until chicken is no longer pink in the center and the juices run clear, 40 to 45 minutes. An instant-read thermometer inserted into the center should read at least 165 degrees F (74 degrees C).",
    ],
    creator: "Meesh",
    type: ["Lunch", "Diner"],
  },
  {
    ...
    serving: 3,
    picture:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F1092268.jpg&w=708&h=708&c=sc&poi=face&q=85",
    level: "Medium",
    duration: 120,
    ingredients: [
      {
    ...
    instructions: [
      ...
      "Step 2: Preheat oven to 350 degrees F (175 degrees C). Spray two 9x5-inch loaf pans with cooking spray or line with aluminum foil for easier cleanup (see Cook's Note).",
  ...
  },
  {
    ...
    serving: 4,
    picture:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F3884031.jpg&w=596&h=596&c=sc&poi=face&q=85",
    level: "Easy",
    duration: 35,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1: Cook and stir ground beef, onion, and jalapeno peppers together in a skillet over medium-high heat until meat is browned and crumbly, 7 to 10 minutes. Stir taco seasoning into meat mixture; bring to a simmer and cook until flavors combine, about 5 minutes.",
      "Step 2: Stir meat mixture, shredded lettuce, tomato, Cheddar cheese, salsa, and sour cream together in a large bowl. Divide taco mixture among 4 bowls and top each with avocado slices.",
    ],
    creator: "Meesh",
    type: ["Lunch", "Diner"],
  },
  {
    ...
    serving: 4,
    picture:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F1120409.jpg&w=708&h=474&c=sc&poi=face&q=85",
    level: "Easy",
    duration: 10,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1: Combine soy sauce, brown sugar, garlic powder, and peanut butter in a small bowl.",
      "Step 2: Heat oil in a large skillet over medium heat; cook and stir frozen vegetables until just tender, 5 to 7 minutes. Remove from heat and fold in soy sauce mixture.",
    ],
    creator: "Meesh",
    type: ["Lunch", "Diner"],
  },
  {
    ...
    serving: 4,
    picture:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F5344921.jpg&w=708&h=474&c=sc&poi=face&q=85",
    level: "Easy",
    duration: 20,
    ingredients: [
      {
    ...
    instructions: [
      "Step 1: In a large salad bowl, combine the Romaine, onion, olives, bell peppers, tomatoes, cucumber and cheese.",
      "Step 2: Whisk together the olive oil, oregano, lemon juice and black pepper. Pour dressing over salad, toss and serve.",
    ],
    creator: "Meesh",
    type: ["Lunch", "Diner"],
  },
